...
export default function SupportPage() {
  ...
  return (
    <div className="content-card">
      <h1>Help &amp; support</h1>
      <p>
        Something broke, or just want to say hi? Drop us a sheet and the team
      ...
      <div className="editor" style={{ marginTop: "var(--space-5)" }}>
        ...
        <div className="field">
          ...
          <textarea
            ...
            value={form.body}
            onChange={set("body")}
            placeholder="Steps to reproduce, browser, what you expected…"
          />
        </div>
      ...
      <p style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <Mail size={18} /> sourabhmahiya.foryou@gmail.com
      </p>
    </div>
  );
}
